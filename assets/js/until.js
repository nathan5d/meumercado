...
function mostrarLista(nomeLista) {
    ...
    let lista = JSON.parse(localStorage.getItem(nomeLista)) || { items: [] };
    // Ordenar a lista
...
function editarItem() {
    ...
    const editQuantityInput = $("#editQuantity");
    const editPriceInput = $("#editPrice");
    const editUnitInput = $("#editUnit");
